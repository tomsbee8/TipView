package cn.blinkdagger.tipview;
...
import com.blinkdagger.fornever.tipview.R;
...
public class TipMenuView extends View {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        textSize = a.getDimension(R.styleable.TipMenuView_tipMenuTextSize, dp2px(context, 14));
